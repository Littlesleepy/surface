 ...
 * @LastEditTime: 2023-04-11 10:11:11
 * @FilePath: \zxi-surface\src\views\HandheldSingleMeasure\components\LevelSlider.VUE
 * @Description:
 -->
 ...
 <template>
   <div>
     <div class="LevelSlider">
       <div class="Slider-Top Slider-text">max：{{ maxLevel.toFixed(1) }}</div>
       <div class="Slider-Content">
         ...
         <div class="Slider-box" @touchstart="SliderStart" @mousedown="SliderStart" @touchmove="SliderMove" @mousemove="SliderMove" @wheel="SliderWheel">
       ...
       <div class="Slider-Footer Slider-text">min：{{ minLevel.toFixed(1) }}</div>
     </div>
   </div>
 </template>
